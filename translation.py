...
/help for more details."""
    WAIT_PROCESS_FINISH = """Please wait for your current file to finish downloading or uploading before sending more links!
    
Or use /cancel to terminate incomplete processes."""
    PROCESS_CANCELLED = """File upload cancelled!
You can now send a new URL."""
    NO_PROCESS_FOUND = """No pending uploads were found. You can upload files by sending a link now!
    
/help por more details."""
